...
>O que valida o ciclo: discovery (ex.: [DXXX](../../docs/strategy/discovery/DXXX-discovery-template.md)), spike(s) concluído(s) (`docs/strategy/spikes/…`). *Cole os links reais ao criar o pitch.*

### Downstream

>*Ao aprovar o ciclo:* mantenha o rastreio — atualize a lista *downstream* no discovery (ou cite o pitch a partir das notas/review). Entregáveis de código e `docs/domain.md` são destinos naturais.
...
>rascunho | pronto para executar | em andamento
